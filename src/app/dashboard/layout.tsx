    ...
    <>
      ...
      <div className="flex overflow-hidden bg-white dark:bg-[#020817] pt-16">
        <aside
          ...
          aria-label="Sidebar"
        >
          <div className="relative flex-1 flex flex-col min-h-0 borderR border-gray-200 bg-white dark:bg-[#020817] pt-0">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 dark:text-white font-normal rounded-lg flex items-center p-2 dark:hover:bg-[#111827] hover:text-black hover:bg-gray-200  group"
                      >
          ...
          <main>
            <div className="pt-6 px-4">
              <div className="w-full min-h-[calc(100vh-230px)]">
                <div className="bg-white dark:bg-[#020817] shadow rounded-lg p-4 sm:p-6 xl:p-8">
                  {children}
                </div>
              </div>
            </div>
          </main>
          <footer className="bg-white dark:bg-[#111827]  md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
